...
import { Globe, Mail, Instagram, MapPin, ArrowUpRight, ChartArea, MessageCircle } from "lucide-react";
    ...
    <section className="bg-[#f4efe8] py-24" id="contact">
      <div className="max-w-3xl mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-5xl font-serif text-[#2f2926]">Bog'lanish</h2>

          <p className="text-gray-500 mt-3">
            Hamkorlik, buyurtma yoki savol uchun murojaat qiling
          </p>
